...
Это Spring Boot приложение для хранения и управления сигнатурами файлов, типами файлов, движками сканирования и отчетами сканирования. Оно демонстрирует различные типы связей между сущностями в JPA.
